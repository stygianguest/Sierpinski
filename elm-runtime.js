...
Elm.Array.make = function (_elm)
                 {
                   ...
                   var updates = F2(function (us,array)
                                    {
                   ...
                   var getSafe = F3(function ($default,i,array)
                                    {
                   ...
                   var getMaybe = F2(function (i,array)
                                     {
                                       return _U.cmp(Native.Array.length(array),
                   ...
                   var indices = function (a)
                                 {
                                   return _L.range(0,Native.Array.length(a) - 1);
                                 };
                   var toIndexedList = function (a)
                                       {
                                         return A2(List.zip,indices(a),Native.Array.toList(a));
                                       };
                   var toList = Native.Array.toList;
                   var fromList = A2(List.foldl,Native.Array.push,Native.Array.empty);
                   ...
                   var zip = zipWith(F2(function (v0,v1)
                                        {
                                          return {ctor: "_Tuple2", _0: v0, _1: v1};
                                        }));
                   var fill = F2(function (len,e)
                                 {
                                   return fromList(A2(List.map,Basics.always(e),_L.range(1,len)));
                                 });
                   var Array = {ctor: "Array"};
                   _elm.Array.values = {_op: _op, fill: fill, fromList: fromList, toList: toList, indices: indices, toIndexedList: toIndexedList, map: map, indexedMap: indexedMap, foldl: foldl, foldr: foldr, zip: zip, zipWith: zipWith, empty: empty, push: push, get: get, getMaybe: getMaybe, getSafe: getSafe, set: set, updates: updates, slice: slice, length: length, concat: concat, Array: Array};
                   return _elm.Array.values;
                 };Elm.Color = Elm.Color || {};
                                       ...
                                       return function ()
                                              {
                                                ...
                                                {case
                                                 ...
                                                 case
                                                 "[]" :
                                                   return {ctor: "_Tuple2", _0: _L.fromArray([]), _1: _L.fromArray([])};}
